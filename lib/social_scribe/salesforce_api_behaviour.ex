defmodule SocialScribe.SalesforceApiBehaviour do
  ...
  @callback create_contact(credential :: UserCredential.t(), contact_data :: map()) ::
              {:ok, map()} | {:error, any()}
  ...
  def create_contact(credential, contact_data) do
    impl().create_contact(credential, contact_data)
  end
