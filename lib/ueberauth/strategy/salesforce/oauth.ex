defmodule Ueberauth.Strategy.Salesforce.OAuth do
  ...
  def get_access_token(params \\ [], opts \\ []) do
    ...
    case opts |> client() |> OAuth2.Client.get_token(params) do
      ...
      {:error, %OAuth2.Response{body: %{"message" => message, "errorCode" => error_code}}} ->
  ...
  @doc """
  Fetches user info from Salesforce using the access token.
  """
  def get_user_info(token) do
    # The instance_url is returned in the token response
    instance_url = token.other_params["instance_url"] || "https://login.salesforce.com"
